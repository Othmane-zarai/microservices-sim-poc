...
% TODO-ARTEFACT: the deployment kit, comparator scripts, and raw captures
% must be published (currently in a private repo) and archived to Zenodo,
% with the DOI substituted at the Section~\ref{sec:conclusions} footnote,
...
% comparator
    ...
    \begin{figure}[!t]
        \centerline{\includegraphics[width=\linewidth]{figures/boutique-trace-comparison-combined}}
...
%%============================================================
    ...
    camera-ready.%
% TODO: replace with exact commit SHA + Zenodo DOI once a clean, test-passing
% snapshot of the fork is committed and tagged.
...
%% --- Back matter ---
    ...
    captures --- accompanies the manuscript. The evaluation reported here was
    produced on JDK~25.0.1 against the fork build; the exact tagged commit and
    an archived Zenodo snapshot (with DOI) will be pinned at camera-ready.%
% TODO-ARTEFACT: publish the deployment kit + comparator scripts + raw
% captures, archive to Zenodo, and substitute the commit SHA + DOI here
% before camera-ready submission.
